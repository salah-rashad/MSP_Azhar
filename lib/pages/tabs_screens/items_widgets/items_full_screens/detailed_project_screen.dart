  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: AppTheme.tab3Secondary,
        ),
        body: ListView(
          ...
          children: <Widget>[
            Container(
              height: 200,
              width: size.width,
              child: _project.image.isNotEmpty ? Image.memory(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    ...
                    style: AppTheme.title.apply(color: AppTheme.tab3Secondary),
                  ),
                  SizedBox(height: 16),
                  AutoDirection(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Text(
                          "Link:".toUpperCase(),
                          style:
                              AppTheme.title.apply(color: AppTheme.tab3Secondary),
                        ),
                      ),
                      Flexible(
                        child: InkWell(
                          ...
                          children: <Widget>[
                            Text(
                              ...
                              style: AppTheme.title
                                  .apply(color: AppTheme.tab3Secondary),
                            ),
                            SizedBox(height: 8),
                            Container(
                              height: 240,
